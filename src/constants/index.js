...
export const HERO_CONTENT = `I am a highly motivated MERN stack developer with strong expertise in building full-stack web applications using technologies like React, Node.js, Express, and MongoDB. With a solid foundation in modern JavaScript, API development, and UI design, I strive to deliver clean, scalable, and efficient code. Passionate about continuous learning and open-source contributions, I aim to create impactful digital solutions that enhance user engagement and business performance.`;
